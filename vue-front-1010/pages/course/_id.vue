      ...
      <div>
          <article class="c-v-pic-wrap" style="height: 357px;">
              <section id="videoPlay" class="p-h-video-box">
                  <img width="100%" height="100%" :src="course.cover" :alt="course.title" class="dis c-v-pic">
              </section>
          </article>
              ...
              <ol class="thr-attr-ol">
                  ...
                  <li>
                      ...
                      <aside>
                          ...
                          <br>
                          <h6 class="c-fff f-fM mt10">{{ course.viewCount/2 }}</h6>
                      </aside>
                  </li>
              </ol>
          </aside>
                          ...
                          <li class="lh-menu-stair" v-for="chapter in chapterList" :key="chapter.id">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.children" :key="video.id">
                                <a
                                  @click="player(video.videoSourceId,video.isFree)"
                                  :title="video.title"
                                  target="_blank">
                                  ...
                                  <span class="fr" v-if="video.videoSourceId === ''">
                                    <i class="free-icon vam mr10">视频未上线</i>
                                  </span>
                    ...
                    <div class="mt50 commentHtml"><div>
                      ...
                      <section class="">
                        ...
                        <section class="no-data-wrap" v-if="data.total==0">
                          ...
                          <span class="c-666 fsize14 ml10 vam">还没有相关评论，快去评论吧...</span>
                        </section>
                        <!-- /无数据提示 结束-->
...
export default {
  ...
  methods:{
    ...
    player(videoId,isFree){
      if(isFree ||this.isbuy || Number(this.course.price)===0){
          if(videoId){
            let routeData = this.$router.resolve({ path: '/player/'+ videoId})
    ...
    addComment(){
        if(this.isbuy || Number(this.course.price)===0){
